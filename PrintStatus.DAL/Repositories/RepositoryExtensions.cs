...
namespace PrintStatus.DAL;

public static class RepositoryExtensions
{
	public static IRepositoryResult<T> HandleException<T>(this IRepositoryResult<T> repositoryResult, Exception ex)
	{
		...
		return RepositoryResult<T>.Failure(errors, message);
	}
}